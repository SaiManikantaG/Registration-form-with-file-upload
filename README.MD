## Registration form with file upload option and forwards the entered user details and uploaded file to the selected email (Just a basic authentication; Can be implemented with OAuth 1.0 or OAuth 2.0)
